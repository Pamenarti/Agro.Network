...
```bash
agrod query staking validators
```
...
```bash
agrod query staking validator fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w
```
...
```bash
agrod query staking delegations-to fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w
```
...
```bash
agrod query staking redelegations-from fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w
```
...
```bash
agrod query staking redelegations fetch15fn3meky8ktfry3qm73xkpjckzw4dazxpfx34m
```
...
```bash
agrod query distribution rewards fetch15fn3meky8ktfry3qm73xkpjckzw4dazxpfx34m
```
...
```bash
agrod query distribution rewards fetch15fn3meky8ktfry3qm73xkpjckzw4dazxpfx34m fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w
```
...
```bash
agrod tx staking delegate fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w 1000000atestfet --from myKey
```
...
```bash
agrod tx staking redelegate fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w fetchvaloper122veneudkzyalay6gusvrhhpp0560mparpanvu 400000atestfet --from myKey
```
...
```bash
agrod tx staking unbond fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w 300000atestfet --from myKey
```
...
```bash
agrod tx distribution withdraw-rewards fetchvaloper1z72rph6l5j6ex83n4urputykawcqg6t98xul2w --from myKey
```
...
```bash
agrod tx distribution withdraw-all-rewards --from myKey
```
