...
DENOM = 'atestfet'
agrod_CONFIG_ROOT = '/root/.agrod/config'
GENESIS_PATH = os.path.join(agrod_CONFIG_ROOT, 'genesis.json')
GENTX_PATH = os.path.join(agrod_CONFIG_ROOT, 'gentx')


def create_genesis(chain_id: str):
    cmd = ['agrod', 'init', 'setup-node', '--chain-id', chain_id]
